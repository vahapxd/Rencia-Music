...
module.exports = {
	...
	async run(client, int, player, embed) {
		...
		await int.reply({
			embeds: [embed(int.guild, int.member.user).setTitle("Bulunan şarkılar").setDescription(`${tracksText}`).setThumbnail("https://cdn.discordapp.com/attachments/1059908288642289664/1061029186355081337/standard.gif")],
			components: comps
		});
